...
<ul class="nav nav-tabs">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu pull-right">
            ...
            <li>
                <a href="javascript:;" data-target="#quick_sidebar_tab_3" data-toggle="tab">
                <i class="fa fa-info"></i> Notifications </a>
            </li>
            <li>
                <a href="javascript:;" data-target="#quick_sidebar_tab_3" data-toggle="tab">
                <i class="fa fa-speech"></i> Activities </a>
            </li>
            <li class="divider"></li>
            <li>
                <a href="javascript:;" data-target="#quick_sidebar_tab_3" data-toggle="tab">
                                        ...
                                        <li> Secondary SMTP Port
                                            ...
                                            <li> Notify On System Error
                                                ...
                                                <div class="inner-content">
                                                    ...
                                                    <i class="fa fa-settings"></i> Save Changes</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
{{--                            </div>--}}
                        ...
                        {
                        change_theme_func(theme);
                        if(theme != '')
                        {
                        $.ajax({
                        url:'{{aurl('theme')}}/'+theme,
                        dataType:'json',
                        type:'get'
                        });
                        }
                        ...
                        function change_theme_session(theme)
                        {
                        change_theme_func(theme);
                        }
                        @if(session()->has('theme'))
                        change_theme_session({{session('theme')}});
                        @endif
