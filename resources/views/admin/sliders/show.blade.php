              ...
              <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('sliders/create')}}"
                           data-toggle="tooltip" title="{{trans('admin.sliders')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                {{trans('admin.ask_del')}} {{trans('admin.id')}} {{$sliders->id}} ؟
...
<b>{{trans('admin.id')}} :</b> {{$sliders->id}}
</div>
<div class="clearfix"></div>
<hr />

<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.heading_ar')}} :</b>
 {!! $sliders->heading_ar !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.heading_en')}} :</b>
 {!! $sliders->heading_en !!}
</div>
