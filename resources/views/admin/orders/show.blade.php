              ...
              <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('orders/create')}}"
                           data-toggle="tooltip" title="{{trans('admin.orders')}}">
                            <i class="fa fa-plus"></i>
                        </a>


                        <span data-toggle="tooltip" title="{{trans('admin.delete')}}  {{trans('admin.orders')}}">

                        <a data-toggle="modal" data-target="#myModal{{$orders->id}}" class="btn btn-circle btn-icon-only btn-default" href="">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                {{trans('admin.ask_del')}} {{trans('admin.id')}} {{$orders->id}} ؟
