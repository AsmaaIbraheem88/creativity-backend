              ...
              <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('portfolios/create')}}"
                           data-toggle="tooltip" title="{{trans('admin.portfolios')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                {{trans('admin.ask_del')}} {{trans('admin.id')}} {{$portfolios->id}} ؟
...
<b>{{trans('admin.id')}} :</b> {{$portfolios->id}}
</div>
<div class="clearfix"></div>
<hr />

<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.service_id')}} :</b>
