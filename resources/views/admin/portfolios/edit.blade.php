						...
						<div class="portlet-title">
								...
								<div class="actions">
										<a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('portfolios/create')}}"
												data-toggle="tooltip" title="{{trans('admin.add')}}  {{trans('admin.portfolios')}}">
												<i class="fa fa-plus"></i>
										</a>
										<span data-toggle="tooltip" title="{{trans('admin.delete')}}  {{trans('admin.portfolios')}}">
												...
												<div class="modal-dialog">
														<div class="modal-content">
																...
																<div class="modal-body">
																		<i class="fa fa-exclamation-triangle"></i>   {{trans('admin.ask_del')}} {{trans('admin.id')}} ({{$portfolios->id}}) ؟
																</div>
										...
										<a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('portfolios')}}"
												data-toggle="tooltip" title="{{trans('admin.show_all')}}   {{trans('admin.portfolios')}}">
...
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::text('name', $portfolios->name ,['class'=>'form-control','placeholder'=>trans('admin.name')]) !!}
    </div>
</div>
<br>
<div class="form-group">
    {!! Form::label('client',trans('admin.client'),['class'=>'col-md-3 control-label']) !!}
    <div class="col-md-9">
        {!! Form::text('client', $portfolios->client ,['class'=>'form-control','placeholder'=>trans('admin.client')]) !!}
    </div>
</div>
<br>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-md-9">
{!! Form::select('service_id',App\Model\Service::pluck("name_en","id"), $portfolios->service_id ,['class'=>'form-control','placeholder'=>trans('admin.service_id')]) !!}
    </div>
</div>
<br>
