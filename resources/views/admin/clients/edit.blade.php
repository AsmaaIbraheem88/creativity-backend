						...
						<div class="portlet-title">
								...
								<div class="actions">
										<a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('clients/create')}}"
												data-toggle="tooltip" title="{{trans('admin.add')}}  {{trans('admin.clients')}}">
												<i class="fa fa-plus"></i>
										</a>
										<span data-toggle="tooltip" title="{{trans('admin.delete')}}  {{trans('admin.clients')}}">
										...
										<a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('clients')}}"
												data-toggle="tooltip" title="{{trans('admin.show_all')}}   {{trans('admin.clients')}}">
...
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::text('name', $clients->name ,['class'=>'form-control','placeholder'=>trans('admin.name')]) !!}
    </div>
</div>
<br>
<div class="form-group">
