...
class PortfoliosDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.portfolios.buttons.actions')
            ->addColumn('image', 'admin.portfolios.buttons.image')
    ...
    {
        return Portfolio::query()->with('service');
