...
class SubChildServicesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.subchildservices.buttons.actions')
    ...
    {
        return SubChildService::query()->with('child_service');
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'child_service.name_en',
                 'data'=>'child_service.name_en',
                 'title'=>trans('admin.child_service'),
		    ],
 [
	                'name' => 'actions',
	                'data' => 'actions',
