...
class ChildServicesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.childservices.buttons.actions')
            ->addColumn('image', 'admin.childservices.buttons.image')
    ...
    {
        return ChildService::query()->with('service');
