...
class ServicesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.services.buttons.actions')
            ->addColumn('image', 'admin.services.buttons.image')
            ->addColumn('active', 'admin.services.buttons.active')
            ...
            ->rawColumns(['checkbox','actions','active','image']);
    }
