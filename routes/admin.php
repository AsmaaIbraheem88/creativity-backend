...
Route::group(['prefix' => app('admin'), 'middleware' => 'Lang'], function () {
		...
		Route::group(['middleware' => 'admin:admin'], function () {
                ...
                Route::resource('childservices','Admin\ChildServices');
                Route::post('childservices/multi_delete','Admin\ChildServices@multi_delete');
                Route::resource('subchildservices','Admin\SubChildServices');
                Route::post('subchildservices/multi_delete','Admin\SubChildServices@multi_delete');
                Route::resource('portfolios','Admin\Portfolios');
                Route::post('portfolios/multi_delete','Admin\Portfolios@multi_delete');
                Route::resource('orders','Admin\Orders')->only(['index','destroy']);
